...
class TFLBusStationArrivalsCellSpecs: QuickSpec {
    ...
    override func spec() {
        ...
        beforeEach {
            ...
            _ = controller.view
            cell = (controller.collectionView.dequeueReusableCell(withReuseIdentifier: String(describing: TFLBusStationArrivalsCell.self), for: IndexPath(row: 0, section: 0)) as!  TFLBusStationArrivalsCell)
        }
