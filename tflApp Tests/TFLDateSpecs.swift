...
class TFLdateSpec: QuickSpec {
    ...
    override func spec() {
        ...
        describe("when asking for elapsed time") {
            ...
            fit ("should return the right string if it happened more than 1 min ago") {
            ...
            fit ("should return the right string if it happened more than 15 mins ago") {
            ...
            fit ("should return the right string if it happened more than 1 hour ago") {
            ...
            fit ("should return the right string if it happened more than 3 hours ago") {
            ...
            fit ("should return the right string if it happened more than 1 day ago") {
            ...
            fit ("should return the right string if it happened a few day ago") {
            ...
            fit ("should return the right string if it happened last week") {
            ...
            fit ("should return the right string if it happened several weeks") {
